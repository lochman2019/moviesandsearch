...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('object', theapp.models.CustomUserManager()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='theapp.postmovie')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='friend_list',
            field=models.ManyToManyField(to='theapp.userfriend'),
        ),
        migrations.AddField(
            model_name='postmovie',
            name='location_tag_list',
            field=models.ManyToManyField(to='theapp.locationtag'),
        ),
        migrations.AddField(
            model_name='postmovie',
            name='tag_list',
            field=models.ManyToManyField(to='theapp.movietag'),
        ),
        migrations.AddField(
            model_name='postmovie',
            name='user',

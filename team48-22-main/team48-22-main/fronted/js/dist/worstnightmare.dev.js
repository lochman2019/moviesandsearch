...
if (window.location.hostname === 'localhost') {
  ...
  REMOTE_BASEURL = '//reeltravel.live/';
}
...
var getTileURL = function getTileURL(lat, lon, zoom) {
...
var movemarker = function movemarker(e) {
  var geopoi_layer = findWithAttr(e.target._layers, "_url", geopoi_url);
...
var dragstartmarker = function dragstartmarker(e) {
...
var onLocationFound = function onLocationFound(e) {
...
var onLocationError = function onLocationError(e) {
  alert(e.message);
};
/*
...
//# sourceMappingURL=worstnightmare.dev.js.map
